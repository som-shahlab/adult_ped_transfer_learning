...
parser.add_argument(
    "--cohort_name", type=str, default="tl_admission_rollup_filtered_temp"
)

parser.add_argument("--index_date_field", type=str, default="admit_date_midnight")
...
parser.add_argument(
    ...
    dest="overwrite",
    action="store_true",
    help="Whether to extract all historical results",
)
